...
class ArizeCallbackHandler(BaseCallbackHandler):
    ...
    def on_chain_start(
        ...
        print("on_chain_start serialized", serialized.get('kwargs', '').get('llm', '').get('kwargs', '').get('base_url', ''))
    ...
    def on_tool_error(self, error: BaseException, **kwargs: Any) -> None:
        print("on_tool_error error", error)
        print("on_tool_error kwargs", kwargs)
        pass

    def on_text(self, text: str, **kwargs: Any) -> None:
        print("on_text text", text)
        print("on_text kwargs", kwargs)
        pass

    def on_agent_finish(self, finish: AgentFinish, **kwargs: Any) -> None:
        print("on_agent_finish finish", finish)
        print("on_agent_finish kwargs", kwargs)
        pass
